...
//    @GetMapping("/children")
//    public ResponseEntity<Iterable<ChildOfEmployee>> getAllChildren(@RequestParam(required = false) String surname) {
//        try {
...
//            } else {
//                childRepository.findBySurname(surname).forEach(childOfEmployees::add);
//            }
//
...
//                    .save(new ChildOfEmployee(childOfEmployee.getChildName(), childOfEmployee.getChildSurname(),
